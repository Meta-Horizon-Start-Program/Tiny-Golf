...
namespace XRMultiplayer
{
    ...
    /// </summary>
    public class BaseNetworkPlayer : NetworkBehaviour
    {
        /// <summary>
        ...
        /// </summary>
        public static BaseNetworkPlayer LocalPlayer;
        ...
        /// Action called when the player color is updated.
        /// </summary>
        public Action<BaseNetworkPlayer> onDisconnected;
        ...
        private void OnEntitlementFinished(PlatformInfo info)
        {
            ...
            var playerName = info.IsEntitled ? info.OculusUser?.DisplayName : "no username";
